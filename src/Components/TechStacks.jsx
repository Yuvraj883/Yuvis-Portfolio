      ...
      <div className='md:flex hidden flex-col  w-4/5 m-auto justify-center items-center px-auto'>
        ...
        <div className='flex justify-center  shadow-lg rounded-md p-2  font-bold text-2xl bg-white m-8'>
          <button
            ...
            className={` ${
              frontEnd
                ? 'bg-[#E5BA73] text-white py-2 px-8 rounded-md'
        ...
        {others === true && (
          <div className='flex  w-4/5 m-auto items-center flex-wrap'>
            ...
            <div>
              <div className='rounded-full m-6 bg-green-50 p-6 '>
                <img
                  src={require('../assets/netlify.webp')}
                  className='h-24'
                  alt='Java'
                />
              </div>
      ...
      <div className='md:hidden flex flex-col  w-full mx-auto my-8 justify-center items-center px-auto'>
        ...
        <div className='flex justify-between shadow-lg rounded-md p-2  font-bold text-xl w-[90%] bg-white m-4'>
          <button
            ...
            className={` ${
              frontEnd
                ? 'bg-[#E5BA73] text-white py-1 text-2xl px-2 rounded-md'
          ...
          <button
            ...
            className={` ${
              others
                ? 'bg-[#E5BA73] text-white py-1 px-2 text-2xl rounded-md'
                : 'hover:bg-[#f1f5f9] py-1 px-2 rounded-md  '
            }`}
          >
            Others
        ...
        {others === true && (
          <div className='flex space-x-2 w-4/5 m-auto justify-center items-center flex-wrap'>
            <div>
              <div className='rounded-full m-4 bg-blue-50 p-2 '>
                <img
                  src={require('../assets/c.png')}
                  className='h-[3.75rem] m-auto'
                  alt='C'
                />
              </div>
